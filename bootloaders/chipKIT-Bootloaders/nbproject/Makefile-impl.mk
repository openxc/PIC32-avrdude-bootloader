...
DEFAULTCONF=CrossChasm_C5_BTLE
CONF=${DEFAULTCONF}

# All Configurations
ALLCONFS=UNO32 MAX32 MX1_EXAMPLE_UART MX2_EBBV3_USB MX2_FB_MINI_USB MX3cK_128 MX3cK_512 MX4_USB MX4_UART MX4_UBW32_USB MX4_FB_SD_USB MX4_FB_SD_512K_USB uC32 MX4cK MX7cK MX7_UART MX7_USB MX7cK_USB_SPLIT_FLASH MX7_UWB32_USB CrossChasm_C5_USB CrossChasm_C5_Cellular CrossChasm_C5_BTLE 
...
.clobber-impl: .clobber-pre .depcheck-impl
	    ...
	    ${MAKE} SUBPROJECTS=${SUBPROJECTS} CONF=CrossChasm_C5_USB clean
	    ${MAKE} SUBPROJECTS=${SUBPROJECTS} CONF=CrossChasm_C5_Cellular clean
	    ${MAKE} SUBPROJECTS=${SUBPROJECTS} CONF=CrossChasm_C5_BTLE clean
...
.all-impl: .all-pre .depcheck-impl
	    ...
	    ${MAKE} SUBPROJECTS=${SUBPROJECTS} CONF=CrossChasm_C5_USB build
	    ${MAKE} SUBPROJECTS=${SUBPROJECTS} CONF=CrossChasm_C5_Cellular build
	    ${MAKE} SUBPROJECTS=${SUBPROJECTS} CONF=CrossChasm_C5_BTLE build
